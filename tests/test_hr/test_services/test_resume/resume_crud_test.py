...
class TestResumeCreate:
    ...
    @pytest.mark.asyncio
    async def test_create_resume_success(self, test_session, sample_resume_data):
    ...
    @pytest.mark.asyncio
    async def test_create_resume_duplicate_email(self, test_session, sample_resume_data):
    ...
    @pytest.mark.asyncio
    async def test_create_resume_invalid_email(self, test_session, sample_resume_data):
    ...
    @pytest.mark.asyncio
    async def test_create_resume_missing_required_fields(self, test_session):
        """Test that missing required fields raises ValueError."""
        with pytest.raises(ValueError, match="Email is required"):
            await create_resume(test_session, {})

    @pytest.mark.asyncio
    async def test_create_resume_future_experience_dates(self, test_session, sample_resume_data):
...
class TestResumeRead:
    """Test resume reading functionality."""

    @pytest.mark.asyncio
    async def test_get_resume_success(self, test_session, sample_resume_data):
    ...
    @pytest.mark.asyncio
    async def test_get_resume_not_found(self, test_session):
    ...
    @pytest.mark.asyncio
    async def test_get_resumes_empty(self, test_session):
        """Test get_resumes with no data."""
        resumes = await get_resumes(test_session)
        assert resumes == []

    @pytest.mark.asyncio
    async def test_get_resumes_with_data(self, test_session, sample_resume_data):
...
class TestResumeUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_resume_success(self, test_session, sample_resume_data):
    ...
    @pytest.mark.asyncio
    async def test_update_resume_not_found(self, test_session):
    ...
    @pytest.mark.asyncio
    async def test_update_resume_duplicate_email(self, test_session, sample_resume_data):
...
class TestResumeDelete:
    ...
    @pytest.mark.asyncio
    async def test_delete_resume_success(self, test_session, sample_resume_data):
    ...
    @pytest.mark.asyncio
    async def test_delete_resume_not_found(self, test_session):
